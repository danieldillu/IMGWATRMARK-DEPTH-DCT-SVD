function [recoveredWImage]=WExtraction2(watermarkedImage,hostImage,gtImage,alphaValuebgfg)
...
for i=1:sz2(1)
    for j=1:sz2(2)
        for k=1:sz2(3)            
            alphat=alpha3DArray(i,j,k);
            dctWatermark(i,j,k)=(wsingValue(i,j,k)-(alphat*singularValueComp(i,j,k)))/(1-alphat);            
        end
    end
end
